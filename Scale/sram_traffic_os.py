...
def sram_traffic(
    ...
    read_cycles, util, total_MAC = gen_read_trace(
                            cycle = cycles,
    ...
    return(str_cycles, util, total_MAC)
# End of sram_traffic()
...
def gen_read_trace(
    ...
    return (local_cycle + cycle), util_perc, total_MAC
